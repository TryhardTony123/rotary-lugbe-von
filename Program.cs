...
<head>
    ...
    <style>
        *{box-sizing:border-box}body{margin:0;min-height:100vh;display:grid;place-items:center;padding:24px;background:#0f2f55;font-family:Arial,sans-serif;color:#1d3048}
        ...
        .brand{display:none}.login-logo{display:block;width:min(300px,100%);height:155px;object-fit:contain;margin:0 auto 22px}
    </style>
</head>
<body>
    <main class="card">
        <img class="login-logo" src="/rotary-logo.jpeg" alt="Rotary Club of Abuja Lugbe VON">
